...
bytes32 constant PER_UNIT = keccak256("EIP-XXXX:NAV_BASIS:PER_UNIT");
bytes32 constant PER_SHARE = keccak256("EIP-XXXX:NAV_BASIS:PER_SHARE");
bytes32 constant TOTAL = keccak256("EIP-XXXX:NAV_BASIS:TOTAL");

bytes32 constant USD = keccak256("EIP-XXXX:CURRENCY:USD");
bytes32 constant EUR = keccak256("EIP-XXXX:CURRENCY:EUR");
