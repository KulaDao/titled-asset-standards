...
///         reports and attests quarterly impact data using EIP-4.
///
...
///   3. Independent attestor endorses both snapshots with evidence
...
contract ExampleERC20ImpactSnapshot is Script {
    ...
    function run() external {
        ...
        uint256 q1CarbonIdx = log.recordSnapshot(
            ...
            1234, 2, UNIT_TCO2E,
            Q1_START, Q1_END,
            METHODOLOGY_V1, METHODOLOGY_V1_URI,
            NO_CORRECTION
        );
