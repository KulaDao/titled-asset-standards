...
contract BundleHashLibTest is Test {
    ...
    function test_computeBundleHash_schemaVersionChangesHash() public {
        ...
        bytes32 hashWithV2 = keccak256(abi.encodePacked(keccak256("ERC-8326:BUNDLE:V2"), leaf));
    ...
    function test_profileConstants() public {
        assertEq(BundleHashLib.SCHEMA_V1, keccak256("ERC-8326:BUNDLE:V1"), "SCHEMA_V1 constant mismatch");
