...
contract ExampleERC721WithDocuments is Script {
    ...
    function _anchorPropertyA(DocumentBundleAnchor anchor, bytes32 anchorA)
        internal returns (bytes32 titleA, bytes32 compA)
    {
    ...
    function _anchorPropertyB(DocumentBundleAnchor anchor, bytes32 anchorB)
        internal returns (bytes32 titleB)
    {
    ...
    function _verifyPerAssetIsolation(
    ...
    function _supersedePropertyA(
        DocumentBundleAnchor anchor,
        bytes32 compA,
        bytes32 anchorA
    ) internal returns (bytes32 compA_v2) {
