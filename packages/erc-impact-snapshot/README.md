...
- Custom indicators should use domain-separated identifiers such as `keccak256("EIP-XXXX:INDICATOR:<NAMESPACE>:<NAME>:V1")`. Do not use generic values such as `keccak256("CUSTOM")`.
